...
public:
	...
	/**
	 *  The topmost placement whose footprint meets this rectangle, or INDEX_NONE.
	 *
	 *  What the brush needs and a single cell cannot give it. A 3x2 wardrobe aimed one cell to
	 *  the left of a crate has a free cell under the cursor and lands on the crate regardless;
	 *  asking about the cell alone answers a question nobody asked, and answers it reassuringly.
	 */
	int32 FindOverlapping(const UMazeObjectLibrary* InLibrary, const FIntPoint& MinXZ,
	                      const FIntPoint& ExtentXZ) const;
