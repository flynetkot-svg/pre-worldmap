...
void UMazeEdMode::Render(const FSceneView* View, FViewport* Viewport, FPrimitiveDrawInterface* PDI)
{
	...
	{
		// The footprint rectangle, in the colour of what would happen: green it fits, red it
		// does not. Seeing the rectangle before the click is the whole answer to "where exactly
		// does a 2x3 wardrobe land when I aim at this cell".
		...
		FMazeGridRenderer::DrawCellHighlight(PDI, Grid, Min, Max,
			bFits ? Style.BrushPaint : Style.BrushErase);
	}
	else
	{
